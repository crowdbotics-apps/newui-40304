"""
Django settings for newui_40304 project.
...
WSGI_APPLICATION = 'newui_40304.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newui_40304 API",
    "DESCRIPTION": "API documentation for newui_40304 App",
    "VERSION": "v1",
}
